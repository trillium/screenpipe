...
export const WEBDRIVER_PORT = Number(process.env.SCREENPIPE_E2E_WEBDRIVER_PORT ?? '4445');
...
export const E2E_DATA_DIR = process.env.SCREENPIPE_E2E_DATA_DIR
  ? resolve(process.env.SCREENPIPE_E2E_DATA_DIR)
